                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                            Menampilkan {{ number_format((($rooms->currentPage() - 1) * $rooms->perPage()) + 1) }} - {{ $rooms->currentPage() == $rooms->lastPage() ? number_format($rooms->total()) : number_format($rooms->currentPage() * $rooms->perPage()) }} dari {{ number_format($rooms->total()) }} Kamar
                            </p>
                        </div>
                    </div>
                </div>
